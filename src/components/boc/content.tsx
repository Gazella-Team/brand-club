    ...
    <section  className="py-[100px]">
      <div className="w-sectionMain mx-auto max-w-main text-white text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          <div className="text-white bg-green-900 p-6 flex flex-col gap-6 rounded-2xl text-left">
          ...
          <div className="text-white bg-green-900 p-6 flex flex-col gap-6 rounded-2xl text-left">            <img className="rounded-2xl" src="/boc/contents/2.webp"></img>
            <div className="flex flex-col gap-1">
          ...
          <div className="text-white bg-green-900 p-6 flex flex-col gap-6 rounded-2xl text-left">            <img className="rounded-2xl" src="/boc/contents/3.webp"></img>
            <div className="flex flex-col gap-1">
          ...
          <div className="text-white bg-green-900 p-6 flex flex-col gap-6 rounded-2xl text-left">            <img className="rounded-2xl" src="/boc/contents/4.webp"></img>
            <div className="flex flex-col gap-1">
          ...
          <div className="text-white bg-green-900 p-6 flex flex-col gap-6 rounded-2xl text-left">            <img className="rounded-2xl" src="/boc/contents/5.webp"></img>
            <div className="flex flex-col gap-1">
          ...
          <div className="text-white bg-green-900 p-6 flex flex-col gap-6 rounded-2xl text-left">            <img className="rounded-2xl" src="/boc/contents/6.webp"></img>
            <div className="flex flex-col gap-1">
