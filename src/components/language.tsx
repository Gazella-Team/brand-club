...
export default function Language() {
  ...
  return (
    <div className="flex bg-green-600 items-center gap-[4px] p-[4px] rounded-main">
      <Link
        href={"/"}
        className={
          currentPath === "/en"
            ? "p-[6px] flex items-center gap-[6px] rounded-maun cursor-pointer"
            : "bg-green-700 p-[6px] flex items-center gap-[6px] rounded-main cursor-pointer"
        }
      >
      ...
      <Link
        ...
        className={
          currentPath === "/en"
            ? "bg-green-500 p-[6px] flex items-center gap-[6px] rounded-main cursor-pointer"
