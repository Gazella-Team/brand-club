      ...
      <section className="py-[150px] pt-[250px]">
        <div className="w-[90%] mx-auto max-w-[800px]">
          ...
          <div className="mb-[50px]">
            ...
            Personoplysninger er alle slags informationer, der i et eller andet omfang kan henføres til dig. Når du benytter vores website indsamler og behandler vi en række sådanne informationer. Det sker f.eks. ved alm. tilgang af indhold, hvis du tilmelder dig vores nyhedsbrev, deltager i konkurrencer eller undersøgelser, registrerer dig som bruger eller abonnent, øvrig brug af services eller foretager køb via websitet. I din tilmeldelse til vores gratis trænings video gælder disse vilkår. Du accepterer at du er over 18 år og at  ocmamasterclass får lov til at opringe/sms til dig, hvis de føler der er behov for det. Vi indsamler og behandler typisk følgende typer af oplysninger: Et unikt ID og tekniske oplysninger om din computer, tablet eller mobiltelefon, dit IP-nummer, geografisk placering, samt hvilke sider du klikker på (interesser). I det omfang du selv giver eksplicit samtykke hertil og selv indtaster informationerne behandles desuden: Navn, telefonnummer, e-mail, adresse og betalingsoplysninger. Det vil typisk være i forbindelse med oprettelse af login eller ved køb.
            </p>
          </div>
          <div className="mb-[50px]">
          ...
          <div className="mb-[50px]">
            ...
            <p className="text-[18px]">
            Vi kan opbevare og beholde dine data i op til 5 år efter dit køb i henhold til bogføringsloven, som kræver sin bibeholdelse af dokumenter i op til 5 år. Du har ret til at få oplyst, hvilke personoplysninger, vi behandler om dig. Du kan desuden til enhver tid gøre indsigelse mod, at oplysninger anvendes. Hvis de oplysninger, der behandles om dig, er forkerte, har du ret til at de bliver rettet. Henvendelse herom kan ske til: Benjamin@organicmasterclass.com. Hvis du vil klage over vores behandling af dine personoplysninger, har du også mulighed for at tage kontakt til Datatilsynet.
            </p>
          </div>
          <div className="mb-[50px]">
            <h1 className="text-[30px] font-[700] mb-[20px]">
